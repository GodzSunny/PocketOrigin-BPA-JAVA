...
import pocketorigin.sprites.Player;
import pocketorigin.sprites.Creature;
import pocketorigin.InputManager;
import pocketorigin.GameAction;
import pocketorigin.Sprite;
import java.awt.*;
import java.awt.event.KeyEvent;
import java.util.Iterator;

import pocketorigin.test.GameCore;

/**
 * GameManager manages all parts of the game.
 */
public class PocketOrigin extends GameCore 
{
...
//        g.drawString("Home: "+ mapLoader.currentMap,700.0f,20.0f);
    ...
    /**
     * Gets the tile that a Sprite collides with. Only the
